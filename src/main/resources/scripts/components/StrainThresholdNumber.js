...
class Component extends React.Component {
    render() {
        return (
            <Textfield id="strainThreshold" label="Threshold Strain" type="number" value={this.props.value} onChange={this.props.update} />
        );
    }
...
const boundProperty = "#  $state.character.strain.base + $state.character.characteristics[$state.character.strain.characteristic]"; // The expression used to determine the value of binding.
