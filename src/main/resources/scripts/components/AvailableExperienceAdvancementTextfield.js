...
class Component extends React.Component {
    render(){
        return <Textfield disabled={this.props.disabled} id="availableExperienceAdvancement" fullWidth={true} label="Available Experience" value={this.props.value} onChange={this.props.update} />;
    }
