...
class Component extends React.Component {
    render(){
        return <Textfield disabled={this.props.disabled} id="startingSpecializationCareerSkills" fullWidth={true} label="Specialization Career Skills" value={this.props.value} onChange={this.props.update} />;
    }
...
const boundProperty = "# $state.character.specializations[0] ? $state.character.specializations[0].careerSkills.join(', ') : '' "; // The expression used to determine the value of binding.
