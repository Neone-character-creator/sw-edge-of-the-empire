...
class Component extends React.Component {
    render(){
        return <Textfield disabled={this.props.disabled} id="speciesBaseAbilityPresence" fullWidth={true} label="Presence" value={this.props.value} onChange={this.props.update} />;
    }
