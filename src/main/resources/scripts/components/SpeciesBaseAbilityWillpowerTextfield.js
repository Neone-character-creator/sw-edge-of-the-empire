...
class Component extends React.Component {
    render(){
        return <Textfield disabled={this.props.disabled} id="speciesBaseAbilityWillpower" fullWidth={true} label="Willpower" value={this.props.value} onChange={this.props.update} />;
    }
