...
class Component extends React.Component {
    render(){
        return <Textfield disabled={this.props.disabled} id="startingSpecializationTalentDescription" fullWidth={true} label="Talent Description" value={this.props.value} onChange={this.props.update} />;
    }
