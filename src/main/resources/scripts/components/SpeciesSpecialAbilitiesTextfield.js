...
class Component extends React.Component {
    render(){
        return <Textfield disabled={this.props.disabled} id="speciesSpecialAbilities" fullWidth={true} label="Special Abilities" value={this.props.value} onChange={this.props.update} />;
    }
