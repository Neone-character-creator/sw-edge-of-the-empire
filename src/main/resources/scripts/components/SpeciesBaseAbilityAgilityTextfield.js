...
class Component extends React.Component {
    render(){
        return <Textfield disabled={this.props.disabled} id="speciesBaseAbilityAgility" fullWidth={true} label="Agility" value={this.props.value} onChange={this.props.update} />;
    }
