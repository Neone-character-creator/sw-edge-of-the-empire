...
class Component extends React.Component {
    render(){
        return <Textfield disabled={this.props.disabled} id="specieswoundsThreshold" fullWidth={true} label="Wounds Threshold" value={this.props.value} onChange={this.props.update} />;
    }
