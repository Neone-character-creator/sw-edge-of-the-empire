...
class Component extends React.Component {
    render() {
        return (
            <Textfield id="thresholdWounds" label="Threshold Wounds" type="number" value={this.props.value} onChange={this.props.update} />
        );
    }
...
const boundProperty = "#  $state.character.wounds.base + $state.character.characteristics[$state.character.wounds.characteristic]"; // The expression used to determine the value of binding.
