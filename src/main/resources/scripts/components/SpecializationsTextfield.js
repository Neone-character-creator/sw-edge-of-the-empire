...
class Component extends React.Component {
    render(){
        return <Textfield disabled={this.props.disabled} id="specializations" fullWidth={true} label="Specialization Trees" value={this.props.value} onChange={this.props.update} />;
    }
...
const boundProperty = "# $state.character.specializations.map(s => s.name).join(', ')"; // The expression used to determine the value of binding.
