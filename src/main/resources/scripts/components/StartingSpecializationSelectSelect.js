...
class Component extends React.Component {
    render(){
        return (<FormControl fullWidth={true}>
                    ...
                    <Select id="startingSpecializationSelect" autoWidth={true} value={this.props.value} onChange={this.props.update}
...
const valueExpression = "# $state.character.career.specializations";
