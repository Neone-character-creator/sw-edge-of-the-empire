...
class Component extends React.Component {
    render(){
        return <Textfield disabled={this.props.disabled} id="startingSpecializationTalentName" fullWidth={true} label="Talent Name" value={this.props.value} onChange={this.props.update} />;
    }
