...
class Component extends React.Component {
    render() {
        return (<Button id="characteristicSubmit" variant="contained" onClick={this.props.onClick} disabled={this.props.disabled} >
                    {this.props.value}
                </Button>);
    }
    ...
    shouldComponentUpdate(nextProps, nextState){
        return this.props.disabled !== nextProps.disabled ||
            ...
            this.props.clickAction !== nextProps.clickAction;
    }
}
...
const action = "# {type:'ADVANCEMENT', advancementType:'characteristic', advancement: $state.selectedAdvancement.characteristic.option}";
