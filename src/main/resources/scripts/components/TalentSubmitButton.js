...
class Component extends React.Component {
    render() {
        return (<Button id="talentSubmit" variant="contained" onClick={this.props.onClick} disabled={this.props.disabled} >
                    {this.props.value}
                </Button>);
    }
...
const action = "# {type:'ADVANCEMENT', advancementType:'talent', advancement: $state.selectedAdvancement.talent.option.name}";
