...
class Component extends React.Component {
    render(){
        return <Textfield disabled={this.props.disabled} id="speciesBaseAbilityCunning" fullWidth={true} label="Cunning" value={this.props.value} onChange={this.props.update} />;
    }
