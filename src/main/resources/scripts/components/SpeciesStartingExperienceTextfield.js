...
class Component extends React.Component {
    render(){
        return <Textfield disabled={this.props.disabled} id="speciesStartingExperience" fullWidth={true} label="Starting Experience" value={this.props.value} onChange={this.props.update} />;
    }
