...
class Component extends React.Component {
    render(){
        return <Textfield disabled={this.props.disabled} id="speciesBaseAbilityIntellect" fullWidth={true} label="Intellect" value={this.props.value} onChange={this.props.update} />;
    }
