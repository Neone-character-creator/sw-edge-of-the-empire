...
class Component extends React.Component {
    render() {
        return (<Button id="skillSubmit" variant="contained" onClick={this.props.onClick} disabled={this.props.disabled} >
                    {this.props.value}
                </Button>);
    }
...
const action = "# {type:'ADVANCEMENT', advancementType:'skill', advancement: $state.selectedAdvancement.skill.option}";
