...
class Component extends React.Component {
    render(){
        return (<FormControl fullWidth={true}>
                    ...
                    <Select id="talentAdvancement" autoWidth={true} value={this.props.value} onChange={this.props.update}
...
const itemTextPath = "option.name";
...
const valueExpression = "# $state.availableAdvancements.talent.options";
