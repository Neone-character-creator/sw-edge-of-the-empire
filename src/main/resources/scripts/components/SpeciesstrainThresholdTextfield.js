...
class Component extends React.Component {
    render(){
        return <Textfield disabled={this.props.disabled} id="speciesstrainThreshold" fullWidth={true} label="Strain Threshold" value={this.props.value} onChange={this.props.update} />;
    }
