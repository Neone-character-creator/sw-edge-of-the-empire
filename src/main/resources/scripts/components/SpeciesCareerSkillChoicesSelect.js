...
class Component extends React.Component {
    render(){
        return (<FormControl fullWidth={true}>
                    ...
                    <Select id="speciesCareerSkillChoices" autoWidth={true} value={this.props.value} onChange={this.props.update}
...
const boundProperty = "$state.character.species.careerSkills"; // The expression used to determine the value of binding.
